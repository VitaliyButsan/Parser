...
// Функция, которая принимает массив строк и возвращает массив структур отсортированных по frequency и string.
...
// Функция, которая считает сколько раз встречается заданое значение в массиве.
...
// Функция, которая сортирует масив по убыванию frequency, а вслучае равенаства по алфавиту.
